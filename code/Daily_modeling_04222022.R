...
#we have a lot more data but lets just focus in on the dryland site in 2021
...
#It seems like model 1 and model 2 are neck to neck in terms of which to pick -- I will go with model 1.
...
plots <- (LME_emmeans + plot_spacer()) / line_graph / DOYxTrt_m1 + 
